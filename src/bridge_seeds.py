...
HCPCS_TO_PRODUCT_CODE_SEED = [
    ...
    ("43264", "FCY", "ercp_calculi_removal",    "high",   "ERCP w/ removal of calculi/debris"),
    ("43265", "FCY", "ercp_calculi_destroy",    "high",   "ERCP w/ destruction of calculi"),
    ("43274", "FCY", "ercp_stent_place",        "high",   "ERCP w/ stent placement (BSC AXIOS-relevant)"),
    ("43275", "FCY", "ercp_stent_remove",       "high",   "ERCP w/ removal of foreign body/stent"),
    ("43276", "FCY", "ercp_stent_exchange",     "high",   "ERCP w/ stent removal + replacement"),
    ("43277", "FCY", "ercp_balloon_dilation",   "high",   "ERCP w/ transendoscopic balloon dilation"),
    ("43278", "FCY", "ercp_ablation_tumor",     "high",   "ERCP w/ ablation of tumor/polyp"),
    ("43240", "FCY", "eus_pseudocyst_drainage", "medium", "EGD/EUS w/ transmural pseudocyst drainage (AXIOS LAMS site)"),
